...
function StatsGenerator() {
  ...
  const [reRollsMessage, setRollsMessage] = useState("After roll your dices, you'll have 3 chances to re-roll one stat of your choice if you want to.");
  ...
  const updateReRolls = (reRolledCount) => {
    ...
    if (reRolledCount === 0) {
      setRollsMessage("You've roll all your chances. Congrats! You're ready to begin your epic journey.");
    ...
    <section className="diceRolls">
      <div className="diceRollTableContainer">
        ...
        <table className="statsTable">
          <tbody>
            ...
            <tr>
              <td> CON</td>
              <td>
                <span id="CONScore" className="statsScores">
                  {stats.CON}
                </span>
              </td>
              <td>
            ...
            <tr>
              <td>STR</td>
              <td>
                <span id="STRScore" className="statsScores">
                  {stats.STR}
                </span>
              </td>
              <td>
            ...
            <tr>
              <td>DEX</td>
              <td>
                <span id="DEXScore" className="statsScores">
                  {stats.DEX}
                </span>
              </td>
              <td>
            ...
            <tr>
              <td>INT</td>
              <td>
                <span id="INTScore" className="statsScores">
                  {' '}
                  {stats.INT}
                </span>
              </td>
            ...
            <tr>
              <td>WIS</td>
              <td>
                <span id="WISScore" className="statsScores">
                  {stats.WIS}
                </span>
              </td>
              <td>
            ...
            <tr>
              <td>CHA</td>
              <td>
                <span id="CHAScore" className="statsScores">
                  {stats.CHA}
                </span>
              </td>
              <td>
        ...
        <div className="screenButtonsContainer">
          <input type="button" value="Roll Dice!" className="screenButtons" id="buttonDice" onClick={generateStats} disabled={isDiceRolled ? true : false} />
          <input type="button" value="Continue" className={'screenButtons'} id={isDiceRolled ? 'activeButton' : 'inactiveButton'} onClick={() => createStats(stats)} />
        </div>
      </div>
